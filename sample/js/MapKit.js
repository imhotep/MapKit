...
(function() {
 ...
 showMap: function() {
 cordovaRef.exec('MapKit.showMap');
 },
 ...
 cordovaRef.exec('MapKit.setMapData', this.options);
 },
 ...
 cordovaRef.exec('MapKit.addMapPins', pinStr);
 },
 
 clearMapPins: function() {
 cordovaRef.exec('MapKit.clearMapPins');
 },
 
 hideMap: function() {
 cordovaRef.exec('MapKit.hideMap', {});
 }
